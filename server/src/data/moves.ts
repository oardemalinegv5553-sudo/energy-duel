...
export const MOVES: MoveDef[] = [
  ...
  { id: 'longdun',     name: '龙盾',       level: 4, cost: 0, type: 'defense', atk: 0,  def: 0,  targetType: 'none',   description: '仅抵挡「龙爪」「降龙十八掌」', specialEffect: 'longdun_block', globalUnlock: true },
  { id: 'xianglong',   name: '降龙十八掌', level: 4, cost: 3, type: 'attack',  atk: 55, def: 0,  targetType: 'single', description: '55 攻，破「超防」' },
  ...
  { id: 'duo', name: '跺',  level: 7, cost: 0, type: 'special_defense', atk: 0, def: 0, targetType: 'none',   description: '反制「欧」，直接击杀欧使用者', specialEffect: 'duo_counter', globalUnlock: true },
  ...
  { id: 'guanyin',   name: '观音坐莲', level: 11, cost: 2, type: 'defense', atk: 0, def: 300, targetType: 'none', description: '本回合并下回合霸体，不会死亡', specialEffect: 'guanyin_buff' },

  // ===== Level 12 =====
  { id: 'du',    name: '毒',   level: 12, cost: 1, type: 'attack',  atk: 51, def: 0,  targetType: 'single', description: '51 攻，破「莲花」' },
  ...
  // ===== Level 13 =====
  { id: 'gangcha',    name: '钢叉',     level: 13, cost: 1, type: 'attack', atk: 50, def: 0, targetType: 'single', description: '50 攻' },
  { id: 'shuangguan', name: '双管齐下', level: 13, cost: 3, type: 'attack', atk: 80, def: 0, targetType: 'single', description: '80 攻，当前最高单体输出' },
];
