...
export interface ServerToClientEvents {
  ...
  game_over: (data: { rankings: Ranking[]; levelUps: LevelUp[]; players: PlayerInfo[]; fairLevelUps?: { playerId: string; nickname: string; oldLevel: number; newLevel: number; kills: number }[]; fairStats?: Record<string, { m: number; kills: number }> }) => void;
